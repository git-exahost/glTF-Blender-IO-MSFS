...
bl_info = {
    ...
    'author': 'Julien Duroure, Scurest, Norbert Nopper, Urs Hanselmann, Moritz Becher, Benjamin Schmithüsen, Jim Eckerlein, and many external contributors, Sérgio Rocha',
    "version": (3, 6, 27.1),
    'blender': (3, 6, 0),
